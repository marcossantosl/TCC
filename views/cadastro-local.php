            ...
            <form method="POST" action="../php/recebelocal.php">
                <div class="formCad">
                    ...
                    <div class="bloco-select">
                        <label> Regição em que o local se encontra </label>
                        <select name="bloco">
                    ...
                    <div class="input">
                        ...
                        <textarea cols=40 rows="7" name="descricao" maxlength="300" wrap="hard" placeholder="Descrição do ambiente (Descrição física, ponto de referência etc..)"></textarea>
                    </div>
                    <div class="input">
                        <i class="fa fa-user-graduate"></i>
                        <textarea cols=40 rows="3" name="funcionarios" maxlength="300" wrap="hard" placeholder="Funcionários ou professores que frequentam o local"></textarea>
                    </div>
                    <div class="input">
                        <i class="fa fa-user-graduate"></i>
                        <textarea cols=40 rows="3" name="alunos" maxlength="300" wrap="hard" placeholder="Discentes que frequentam o local"></textarea>
                    </div>
                    <br>
                    <div class="button">
