    ...
    <div class="container pt-5">
      <div class="row firstRowSlide">
        <div class="col-lg-4 col-md-6 align-self-center mb-md-0 mb-4">
          ...
          <h4>É um site informativo, cujo objetivo é atender a comunidade de alunos do Instituto Federal Catarinense - Campus Avançado Sombrio, assistindo os educandos na organização e orientação pelo Campus. Além do mais, também se adequa como uma ferramenta assistiva, favorecendo e incluindo os discentes com baixa ou nenhuma visão.
          </h4>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-5 col-md-6 align-self-center mb-md-0 order-md-2 order-1">
          ...
          <h4>Tem por finalidade fornecer horários atualizados dos cursos integrados, notificações sobre as aulas e atualizações, calendários acadêmicos, regras e normas do instituto, cronogramas personalizados para aqueles alunos que não cursam a quantidade habitual de matérias, meios de contato de funcionários especializados e professores, também traz soluções em questão da noção espacial, com dados importantes referente sobre setores, salas e laboratórios da instituição.
          </h4>
        </div>
      </div>
    </div>
